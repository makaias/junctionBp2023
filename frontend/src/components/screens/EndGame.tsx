  ...
  return (
    ...
    >
      <div className="flex w-full max-w-2xl flex-col justify-center bg-gradient-to-r from-[#000000E6] to-[#000000CC] rounded-xl p-4">
        <h1 className="p-4 mb-10 text-3xl font-bold text-center">{appState.game?.gameState === "LOST" ? "Better luck next time" : "Congratulations, you convinced someone to save the world!"}</h1>
